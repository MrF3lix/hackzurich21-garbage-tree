...
const Help = () => (
    <div className="inner">
        <Head>
            <title>Saaro&Saaro - How it works</title>
        </Head>
        <div className="container container--help">
            <div>
                ...
                <div className="buttons">
                    <button className="button button--danger">Consumer</button>
        ...
        <div className="container container--help">
            <div className="container__left">
                ...
                <p className="subtitle">
                    We provide the tools to access, understand, and see where
                    medical information comes from and how it change over time.
                </p>
            </div>
            ...
            <div>
                ...
                <div className="step bg-dark-gray">
                    <h3>
                        <span className="in-cicle">3</span>
                        Scan the QR code
                    </h3>
                    <p className="subtitle">
                        On the back of the package there is a qr code, which
